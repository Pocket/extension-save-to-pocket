...
const entryInjection = [
  ...
  // We include the app code after this injection in case there's a runtime
  // error during initialization, it doesn't blow up the WebpackDevServer
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      inject: true,
      template: paths.options + '/options.html',
    ...
    // ! ADDED
    // Since we are developing an extension we need to write to file as we develop
    // in order to sideload the extension
