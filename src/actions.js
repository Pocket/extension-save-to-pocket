...
export const TOGGLE_ON_SAVE_RECS = 'TOGGLE_ON_SAVE_RECS'
export const TOGGLE_TWITTER = 'TOGGLE_TWITTER'
...
export const CHECK_TWITTER_INTEGRATION = 'CHECK_TWITTER_INTEGRATION'
export const START_TWITTER_INTEGRATION = 'START_TWITTER_INTEGRATION'
export const STOP_TWITTER_INTEGRATION = 'STOP_TWITTER_INTEGRATION'
export const SAVE_TWEET_TO_POCKET = 'SAVE_TWEET_TO_POCKET'

export const TWITTER_SAVE_REQUEST = 'TWITTER_SAVE_REQUEST'
export const TWITTER_SAVE_SUCCESS = 'TWITTER_SAVE_SUCCESS'
export const TWITTER_SAVE_FAILURE = 'TWITTER_SAVE_FAILURE'
